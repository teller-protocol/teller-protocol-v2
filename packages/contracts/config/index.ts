 ...
 */
export const getTokens = async (hre: HardhatRuntimeEnvironment): Promise<AllNetworkTokens> => {
  const networkTokens = hre.network.name === 'hardhat'
...
const deployHardhatTokens = async (hre: HardhatRuntimeEnvironment): Promise<NetworkTokens> => {
