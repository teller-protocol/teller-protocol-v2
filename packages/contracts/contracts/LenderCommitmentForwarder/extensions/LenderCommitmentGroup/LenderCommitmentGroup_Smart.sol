...
import { ISmartCommitment} from "../../../interfaces/ISmartCommitment.sol";
...
Initializable
{
    ...
    /// @custom:oz-upgrades-unsafe-allow state-variable-immutable
    ISmartCommitmentForwarder public immutable SMART_COMMITMENT_FORWARDER;
    ...
    constructor(
        ...
        SMART_COMMITMENT_FORWARDER = ISmartCommitmentForwarder(
