...
library LenderManagerArt {
    ...
    bytes constant _bg_defs_filter =
        abi.encodePacked(
            "<filter id='f1'>",
    ...
    bytes constant _bg_defs_clip_path =
        abi.encodePacked(
            "<clipPath id='corners'>",
    ...
    bytes constant _clip_path_corners =
        abi.encodePacked(
    ...
    bytes constant _teller_logo_path_1 =
        abi.encodePacked(
    ...
    bytes constant _teller_logo_path_2 =
        abi.encodePacked(
    ...
    function _generate_large_title(string memory amount, string memory symbol)
        public
        pure
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    "<text y='90px' x='32px' fill='white' font-family='Courier New, monospace' font-weight='200' font-size='12px'><tspan font-size='36px'>",
                    amount,
                    "</tspan> ",
                    symbol,
                    "</text>",
    ...
    function _get_token_amount_formatted(uint256 amount, uint256 decimals)
        public
        pure
        returns (string memory)
    {
    ...
    function _get_interest_rate_formatted(uint16 interestRate)
        public
        pure
        returns (string memory)
    {
    ...
    function _get_duration_formatted(uint32 sec)
        public
        pure
        returns (string memory)
    {
    ...
    function _get_token_symbol(address nftContract, string memory _fallback)
        public
        view
        returns (string memory)
    {
    ...
    function _get_collateral_label(Collateral memory collateral)
        public
        view
        returns (string memory)
    {
        ...
        if (collateral._collateralType == CollateralType.ERC20) {
            string
                memory collateralAmountFormatted = _get_token_amount_formatted(
                    collateral._amount,
    ...
    function generateSVG(
        ...
        string memory principalTokenSymbol = _get_token_symbol(
