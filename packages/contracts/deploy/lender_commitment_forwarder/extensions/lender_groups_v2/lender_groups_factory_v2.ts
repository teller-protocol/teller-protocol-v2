...
// tags and deployment
deployFn.id = 'lender-commitment-group-factory-v2:deploy'
deployFn.tags = ['lender-commitment-group-factory-v2']
...
deployFn.skip = async (hre) => {
  return !hre.network.live || !['sepolia','polygon','mainnet','mainnet_live_fork','arbitrum','base','optimism','katana','hyperevm','bsc'].includes(hre.network.name)
}
