...
const deployFn: DeployFunction = async (hre) => {
  hre.log('----------')
  hre.log('')
  hre.log('FlashRolloverLoan G5: Proposing upgrade...')
  ...
  await hre.upgrades.proposeBatchTimelock({
    ...
    description: ` 
# FlashRolloverLoan G5 (Extensions Upgrade)

* Upgrades the flash rollover loan contract to support referral rewards.
`,
    _steps: [
      {
...
// tags and deployment
deployFn.id = 'lender-commitment-forwarder:extensions:flash-rollover:g5-upgrade'
deployFn.tags = [
  'proposal',
  'upgrade',
  ...
  'lender-commitment-forwarder:extensions:flash-rollover:g5-upgrade',
]
