...
const deployFn: DeployFunction = async (hre) => {
  hre.log('----------')
  hre.log('')
  hre.log('BSC: Transferring ownership of contracts to Safe Multisig')
  hre.log('')
...
// tags and deployment
deployFn.id = 'bsc:transfer-ownership-to-safe'
deployFn.tags = ['bsc', 'bsc:transfer-ownership-to-safe']
...
deployFn.skip = async (hre) => {
  return !hre.network.live || hre.network.name !== 'bsc'
}
