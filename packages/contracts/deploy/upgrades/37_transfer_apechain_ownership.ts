...
const deployFn: DeployFunction = async (hre) => {
  hre.log('----------')
  hre.log('')
  hre.log('ApeChain: Transferring ownership of contracts to Safe Multisig')
  hre.log('')
...
// tags and deployment
deployFn.id = 'apechain:transfer-ownership-to-safe'
deployFn.tags = ['apechain', 'apechain:transfer-ownership-to-safe']
