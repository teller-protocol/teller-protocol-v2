...
export default <HardhatUserConfig>{
  ...
  etherscan: {
    apiKey: {
      ...
      katana: process.env.KATANASCAN_VERIFY_API_KEY,
    ...
    customChains: [
      {
      ...
      },
       {
        ...
        chainId: 747474,
        urls: {
          apiURL: 'https://explorer-katana.t.conduit.xyz/api',
  ...
  namedAccounts: {
    ...
    protocolOwnerSafe: {
      ...
      747474: '0x7b0f8D1cff60CD479B5F4a69815Ab90073f5e363', //katana
    ...
    protocolTimelock: {
      ...
      100000002: '0xe6774DAAEdf6e95b222CD3dE09456ec0a46672C4',
       ...
       747474: '0xfA87381128aAF95fB637BbA0B760bA2f9970c2b5', //katana
    ...
    */
    ...
    base: networkConfig({
     ...
     katana: networkConfig({
      ...
      verify: {
        etherscan: {
          apiKey: process.env.KATANASCAN_VERIFY_API_KEY,
        },
      },
    }),
