...
contract MarketRegistry_Override is MarketRegistry {
    ...
    function attestStakeholderVerification(
     ...
     function revokeStakeholderVerification(
       ...
       super._revokeStakeholderVerification(_marketId,_stakeholderAddress,_isLender);
    } 
    ...
    function forceVerifyBorrowerForMarket(uint256 _marketId, address guy) public {
  ...
  function _revokeStakeholder(
    ...
    ) internal override view returns (bool isVerified_, bytes32 uuid_) {
