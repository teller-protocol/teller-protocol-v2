...
1b. **Lock the implementation (recommended).** Right after the deploy, the deployer calls `initialize` on `NEW_IMPL`, so nobody else can. The config copies this pool's tokens, market (14) and oracle route; the loan parameters are neutral because the implementation holds no funds:
   ```
   
   ```
   Then, optionally, it hands ownership of the implementation to the protocol owner with `transferOwnership(0x2f74c448…f66a)` on `NEW_IMPL`:
   ```
