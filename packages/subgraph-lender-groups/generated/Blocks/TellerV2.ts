...
export class TellerV2__calculateAmountDue1ResultDueStruct extends ethereum.Tuple {
  get principal(): BigInt {
    return this[0].toBigInt();
  }
...
export class TellerV2__calculateAmountOwed1ResultOwedStruct extends ethereum.Tuple {
  get principal(): BigInt {
    return this[0].toBigInt();
  }
...
export class TellerV2 extends ethereum.SmartContract {
  ...
  calculateAmountDue1(
    _bidId: BigInt
  ): TellerV2__calculateAmountDue1ResultDueStruct {
    let result = super.call(
      "calculateAmountDue",
      "calculateAmountDue(uint256):((uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(_bidId)]
    );

    return changetype<TellerV2__calculateAmountDue1ResultDueStruct>(
      result[0].toTuple()
    );
  }

  try_calculateAmountDue1(
    _bidId: BigInt
  ): ethereum.CallResult<TellerV2__calculateAmountDue1ResultDueStruct> {
    let result = super.tryCall(
      "calculateAmountDue",
      "calculateAmountDue(uint256):((uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(_bidId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<TellerV2__calculateAmountDue1ResultDueStruct>(
        value[0].toTuple()
      )
    );
  }
  ...
  calculateAmountOwed1(
    _bidId: BigInt
  ): TellerV2__calculateAmountOwed1ResultOwedStruct {
    let result = super.call(
      "calculateAmountOwed",
      "calculateAmountOwed(uint256):((uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(_bidId)]
    );

    return changetype<TellerV2__calculateAmountOwed1ResultOwedStruct>(
      result[0].toTuple()
    );
  }

  try_calculateAmountOwed1(
    _bidId: BigInt
  ): ethereum.CallResult<TellerV2__calculateAmountOwed1ResultOwedStruct> {
    let result = super.tryCall(
      "calculateAmountOwed",
      "calculateAmountOwed(uint256):((uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(_bidId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<TellerV2__calculateAmountOwed1ResultOwedStruct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getLoanSummary(_bidId: BigInt): TellerV2__getLoanSummaryResult {
    let result = super.call(
      "getLoanSummary",
      "getLoanSummary(uint256):(address,address,uint256,address,uint256,uint32,uint8)",
      [ethereum.Value.fromUnsignedBigInt(_bidId)]
    );
...
export class SetLenderManagerCall extends ethereum.Call {
  get inputs(): SetLenderManagerCall__Inputs {
    return new SetLenderManagerCall__Inputs(this);
  }

  get outputs(): SetLenderManagerCall__Outputs {
    return new SetLenderManagerCall__Outputs(this);
  }
}

export class SetLenderManagerCall__Inputs {
  _call: SetLenderManagerCall;

  constructor(call: SetLenderManagerCall) {
    this._call = call;
  }
...
export class SetLenderManagerCall__Outputs {
  _call: SetLenderManagerCall;
