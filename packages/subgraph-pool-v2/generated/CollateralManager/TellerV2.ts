...
export class LoanClosed extends ethereum.Event {
  get params(): LoanClosed__Params {
    return new LoanClosed__Params(this);
  }
}

export class LoanClosed__Params {
  _event: LoanClosed;

  constructor(event: LoanClosed) {
    this._event = event;
  }
...
export class TellerV2 extends ethereum.SmartContract {
  ...
  getEscrowVault(): Address {
    let result = super.call("getEscrowVault", "getEscrowVault():(address)", []);

    return result[0].toAddress();
  }

  try_getEscrowVault(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getEscrowVault",
      "getEscrowVault():(address)",
      []
  ...
  getLoanDefaultTimestamp(_bidId: BigInt): BigInt {
    let result = super.call(
      "getLoanDefaultTimestamp",
      "getLoanDefaultTimestamp(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(_bidId)]
    );
  ...
  try_getLoanDefaultTimestamp(_bidId: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getLoanDefaultTimestamp",
      "getLoanDefaultTimestamp(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(_bidId)]
  ...
  getProtocolPausingManager(): Address {
    let result = super.call(
      "getProtocolPausingManager",
      "getProtocolPausingManager():(address)",
      []
    );
  ...
  try_getProtocolPausingManager(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getProtocolPausingManager",
      "getProtocolPausingManager():(address)",
      []
  ...
  getRepaymentListenerForBid(_bidId: BigInt): Address {
    let result = super.call(
      "getRepaymentListenerForBid",
      "getRepaymentListenerForBid(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(_bidId)]
    );
  ...
  try_getRepaymentListenerForBid(_bidId: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getRepaymentListenerForBid",
      "getRepaymentListenerForBid(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(_bidId)]
  ...
  repaymentListenerForBid(param0: BigInt): Address {
    let result = super.call(
      "repaymentListenerForBid",
      "repaymentListenerForBid(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  try_repaymentListenerForBid(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "repaymentListenerForBid",
      "repaymentListenerForBid(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
...
export class InitializeCall__Inputs {
  ...
  get _protocolPausingManager(): Address {
...
export class LenderCloseLoanWithRecipientCall extends ethereum.Call {
  get inputs(): LenderCloseLoanWithRecipientCall__Inputs {
    return new LenderCloseLoanWithRecipientCall__Inputs(this);
  }

  get outputs(): LenderCloseLoanWithRecipientCall__Outputs {
    return new LenderCloseLoanWithRecipientCall__Outputs(this);
  }
}

export class LenderCloseLoanWithRecipientCall__Inputs {
  _call: LenderCloseLoanWithRecipientCall;

  constructor(call: LenderCloseLoanWithRecipientCall) {
    this._call = call;
  }
...
export class LenderCloseLoanWithRecipientCall__Outputs {
  _call: LenderCloseLoanWithRecipientCall;
...
export class LiquidateLoanFullWithRecipientCall extends ethereum.Call {
  get inputs(): LiquidateLoanFullWithRecipientCall__Inputs {
    return new LiquidateLoanFullWithRecipientCall__Inputs(this);
  }

  get outputs(): LiquidateLoanFullWithRecipientCall__Outputs {
    return new LiquidateLoanFullWithRecipientCall__Outputs(this);
  }
}

export class LiquidateLoanFullWithRecipientCall__Inputs {
  _call: LiquidateLoanFullWithRecipientCall;

  constructor(call: LiquidateLoanFullWithRecipientCall) {
    this._call = call;
  }
...
export class LiquidateLoanFullWithRecipientCall__Outputs {
  _call: LiquidateLoanFullWithRecipientCall;
...
export class SetProtocolPausingManagerCall extends ethereum.Call {
  get inputs(): SetProtocolPausingManagerCall__Inputs {
    return new SetProtocolPausingManagerCall__Inputs(this);
  }

  get outputs(): SetProtocolPausingManagerCall__Outputs {
    return new SetProtocolPausingManagerCall__Outputs(this);
  }
}

export class SetProtocolPausingManagerCall__Inputs {
  _call: SetProtocolPausingManagerCall;

  constructor(call: SetProtocolPausingManagerCall) {
    this._call = call;
  }
...
export class SetProtocolPausingManagerCall__Outputs {
  _call: SetProtocolPausingManagerCall;
...
export class SetRepaymentListenerForBidCall extends ethereum.Call {
  get inputs(): SetRepaymentListenerForBidCall__Inputs {
    return new SetRepaymentListenerForBidCall__Inputs(this);
  }

  get outputs(): SetRepaymentListenerForBidCall__Outputs {
    return new SetRepaymentListenerForBidCall__Outputs(this);
  }
}

export class SetRepaymentListenerForBidCall__Inputs {
  _call: SetRepaymentListenerForBidCall;

  constructor(call: SetRepaymentListenerForBidCall) {
    this._call = call;
  }
  ...
  get _listener(): Address {
    return this._call.inputValues[1].value.toAddress();
  }
}

export class SetRepaymentListenerForBidCall__Outputs {
  _call: SetRepaymentListenerForBidCall;
