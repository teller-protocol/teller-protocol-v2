...
export class LenderCommitmentForwarderStaging__commitmentsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: i32;
...
export class LenderCommitmentForwarderStaging__createCommitmentInput_commitmentStruct extends ethereum.Tuple {
...
export class LenderCommitmentForwarderStaging extends ethereum.SmartContract {
  static bind(address: Address): LenderCommitmentForwarderStaging {
    return new LenderCommitmentForwarderStaging(
  ...
  commitments(
    param0: BigInt
  ): LenderCommitmentForwarderStaging__commitmentsResult {
    let result = super.call(
      "commitments",
    ...
    return new LenderCommitmentForwarderStaging__commitmentsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toI32(),
  ...
  try_commitments(
    param0: BigInt
  ): ethereum.CallResult<LenderCommitmentForwarderStaging__commitmentsResult> {
    let result = super.tryCall(
      "commitments",
      "commitments(uint256):(uint256,uint32,uint32,uint16,address,uint256,uint256,uint8,address,uint256,address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new LenderCommitmentForwarderStaging__commitmentsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toI32(),
  ...
  createCommitment(
    _commitment: LenderCommitmentForwarderStaging__createCommitmentInput_commitmentStruct,
