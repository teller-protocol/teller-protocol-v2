...
export class LenderCommitmentForwarderAlpha extends ethereum.SmartContract {
  ...
  getCommitmentCollateralTokenAddress(_commitmentId: BigInt): Address {
    let result = super.call(
      "getCommitmentCollateralTokenAddress",
      "getCommitmentCollateralTokenAddress(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(_commitmentId)]
    );
  ...
  try_getCommitmentCollateralTokenAddress(
    _commitmentId: BigInt
  ...
  getCommitmentPrincipalTokenAddress(_commitmentId: BigInt): Address {
    let result = super.call(
      "getCommitmentPrincipalTokenAddress",
      "getCommitmentPrincipalTokenAddress(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(_commitmentId)]
    );
  ...
  try_getCommitmentPrincipalTokenAddress(
    _commitmentId: BigInt
  ): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getCommitmentPrincipalTokenAddress",
