...
export class SetEscrowVaultCall extends ethereum.Call {
  get inputs(): SetEscrowVaultCall__Inputs {
    return new SetEscrowVaultCall__Inputs(this);
  }

  get outputs(): SetEscrowVaultCall__Outputs {
    return new SetEscrowVaultCall__Outputs(this);
  }
}

export class SetEscrowVaultCall__Inputs {
  _call: SetEscrowVaultCall;

  constructor(call: SetEscrowVaultCall) {
    this._call = call;
  }
...
export class SetEscrowVaultCall__Outputs {
  _call: SetEscrowVaultCall;
